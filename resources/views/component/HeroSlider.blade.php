                        ...
                        <div class="row">
                            <div class="col-lg-7 col-9">
                                <div class="banner_content overflow-hidden">
                                    <h5 class="mb-3 text-danger staggered-animation font-weight-light" data-animation="slideInLeft" data-animation-delay="0.5s">${item['price']}</h5>
                                    <h2 class="staggered-animation text-danger"  data-animation="slideInLeft" data-animation-delay="1s">${item['title']}</h2>
